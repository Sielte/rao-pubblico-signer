"""
Django settings for sieltesign project.
...
WSGI_APPLICATION = 'sieltesign.wsgi.application'
...
LOGGING = {
    ...
    'filters': {
        'version_filter': {
            '()': 'sieltesign.classes.version_filter.MyFilter'
        }
